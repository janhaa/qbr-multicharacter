...
$(document).on("click", ".character", function (e) {
  ...
  if (selectedChar === null) {
    ...
    if (selectedChar.data("cid") == "") {
      ...
      $.post(
        "https://qbr-multicharacter/cDataPed",
        JSON.stringify({
          cData: cDataPed,
        })
      );
...
$(document).on("click", "#create", function (e) {
  ...
  if (
    ...
    $.post(
      "https://qbr-multicharacter/createNewCharacter",
      JSON.stringify({
        firstname: firstname,
        lastname: lastname,
...
$(document).on("click", "#accept-delete", function (e) {
  $.post(
    "https://qbr-multicharacter/removeCharacter",
    JSON.stringify({
...
$(document).on("click", "#play", function (e) {
  ...
  if (selectedChar !== null) {
    if (charData !== "") {
      $.post(
        "https://qbr-multicharacter/selectCharacter",
        JSON.stringify({
